...
def draw_rectangles(image,
    ...
    def _draw_fn(inputs):
        ...
        canvas = tf.py_func(
            func=lambda x, y, z, w: _py_draw_rectangles(x, y, z, w, color=color, thickness=thickness,
                                                        fontscale=fontscale),
...
def draw_rectangles_v2(image,
    ...
    def _draw_fn(inputs):
        ...
        canvas = tf.py_func(
            func=lambda a, b, c, d, e: _py_draw_rectangles_v2(a, b, c, d, e, color=color, thickness=thickness,
                                                              fontscale=fontscale),
